...
ggsave(
    "~/Library/CloudStorage/OneDrive-UniversityofNewHampshire/GreenManureProject/WRITING/plots/expt2_cyano_pca_plot.jpg",
    pca_plot,
    width = 6,
    height = 4
)
...
ggsave(
    "~/Library/CloudStorage/OneDrive-UniversityofNewHampshire/GreenManureProject/WRITING/plots/expt2_DWcyano_pca_plot.jpg",
    combined_plot,
    width = 6,
    height = 6
)
