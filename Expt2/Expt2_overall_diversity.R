...
div_plot <- ggplot(
    ...
    labs(x = "Green Manure Source", y = "Shannon Diversity Index") +
...
mean(shannon_div_df$ShannonDiversity[
    shannon_div_df$treatment_category == "Duckweed"
])
#average shannon score for water treatment
mean(shannon_div_df$ShannonDiversity[
    shannon_div_df$treatment_category == "Water"
])
