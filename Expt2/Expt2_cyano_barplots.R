...
otu_treatment_counts_full$treatment_category <- factor(
    otu_treatment_counts_full$treatment_category,
...
otu_relative_abundance$Family <- factor(
    otu_relative_abundance$Family,
    levels = family_order,
    ordered = TRUE
)
...
otu_relative_abundance$pond_full_name <- recode(
    otu_relative_abundance$pond,
    !!!pond_name_mapping
)
...
otu_relative_abundance$pond_full_name <- factor(
    otu_relative_abundance$pond_full_name,
    levels = pond_levels
)
