...
**NOTE**: The command `qiime tools export` exports the feature table as a .biom file, so I used `biom convert -i table.biom -o table.from_biom.txt --to-tsv` to convert the table to a tsv to be used in R.
